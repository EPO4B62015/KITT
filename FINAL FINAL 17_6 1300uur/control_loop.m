...
static_positions.origin = [0;103;0]; %start position
static_positions.destination = [500;497;0];
static_positions.waypoint = [0;0;0];
%static_positions.waypoint = [193;400;0];
...
static_positions.mic_positions = [0 0 40; 600 0 40; 600 600 40; 0 600 40; 300 0 46];
    ...
    function timer_loop(timerObj, timerEvent)
        switch(state)
            ...
            case States.Sample
                ...
                pass = localize_5ch(TDOA_data, ((100/1.3) * car.time) + (15 * drive_counter) + (50 * middle_counter));
                %pass = 1;
                if(pass ~= 8)
                    middle_counter = 0;
                end
                ...
                if(pass == 1)
                    ...
                    if(pass == 8)
                        ...
                        drive_car(car.speed, car.steer_straight, 0.7);
                    end
                    if(fail_factor >= 3)
