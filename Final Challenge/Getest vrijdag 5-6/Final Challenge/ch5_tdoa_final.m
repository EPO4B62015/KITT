...
% 
position_mic_mf(1) = loc_peak_1_final(channel_fe_1);
position_mic_mf(2) = distance_final(position_mic_mf(1), channel_fe_2);
position_mic_mf(3) = distance_final(position_mic_mf(1), channel_fe_3);
position_mic_mf(4) = distance_final(position_mic_mf(1), channel_fe_4);
position_mic_mf(5) = distance_final(position_mic_mf(1), channel_fe_5);
